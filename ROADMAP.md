...
- **v1.0 Release Preparedness**: all three apps (Letters, Tables, Decks) build, run, and ship as Flatpaks with reproducible build targets.
...
- ⚠️ **GUI-layer God-file Refactoring**: window.rs 2.6K/2.5K/1.6K LOC in tables/letters/decks (#168) — ongoing architectural decomposition to GTK-free core crates.
...
| P1 | Decks: direct manipulation, themes/layouts, presenter view | #115, #116, #117 | 🟡 In progress |
| P1 | Enterprise fleet deployment & system policy management framework | strategy/enterprise-fleet | 🟡 In progress |
...
| P2 | A11y: keyboard + AT-SPI screen-reader automated compliance gate | #120 | 🟡 In progress |
...
**Theme**: Release hardening, Flatpak distribution, enterprise fleet manageability, and AT-SPI accessibility compliance.

| Goal | Owner | Tracking | Status |
|------|-------|----------|--------|
| Flatpak reproducible builds & atomic crash recovery release gate | strategist / quality | #122 | 🟡 Scheduled |
| Enterprise fleet deployment, dconf/sysadmin policy lockdown & telemetry policy controls | strategist / architect | strategy/enterprise-fleet | 🟡 Scheduled |
| Automated AT-SPI screen reader compliance gate & HIG visual accessibility audit | strategist / quality | #120 | 🟡 Scheduled |
| Headless CLI batch conversion binaries & IPC/WASM plugin SDK framework | strategist / architect | strategy/headless-cli | 🟡 Scheduled |
...
---
*Maintained by the strategist agent (tuna-os hive). Last self-review: 2026-09-11 — updated Q4 2026 release roadmap, enterprise policy lockdown, and AT-SPI accessibility gate.*
