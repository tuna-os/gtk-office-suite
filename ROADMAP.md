...
- **Measured parity** (ratcheted corpora, docs/PARITY.md): CommonMark 630/652, LO-Letters 109/109, LO-Decks 9/9, OpenFormula 107/107. Nightly LibreOffice oracle tests enforce green ODF interop (`REQUIRE_SOFFICE=1`).
- Ctrl+K command palette; per-app live status surfaces; GUI smoke journeys deterministic (#187).
- 21 open issues; daily merged PRs (08-11: GTK-free canonical controllers #186, fuzz coverage #185, quick-xml 0.42 str API migration #298).
...
| P2 | Release gate: Flatpak distribution, upgrade recovery, reproducible builds | #122, #590 | 🟡 In progress |
| P2 | A11y: keyboard + screen-reader AT-SPI automated audit journeys | #120 | ⬜ Not started |
...
**Theme**: production release readiness, Flatpak distribution reproducibility, AT-SPI automated audit gates, and document interop loss budgets.

| Goal | Owner | Tracking | Status |
|------|-------|----------|--------|
| Flatpak reproducible builds & automated release gate validation | release / operations | #122, #590 | 🟡 In progress |
| Interop loss budget inspector & versioned fixture corpus | architect / quality | #105, #121 | ⬜ Not started |
| Decks presenter view, theme editor & slide layout scope | architect | #115, #116 | ⬜ Not started |
| AT-SPI automated accessibility audit gate integration | quality / a11y | #120 | ⬜ Not started |
