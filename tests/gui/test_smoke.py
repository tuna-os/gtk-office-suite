...
class TablesLiveOwnerSmoke(BaseGUITestCase):
    ...
    def setUp(self):
        self._state_dir = self.isolate_autosave_state(prefix="tables-live-owner-")
        super().setUp()

    def _snapshot_dir(self):
        return os.path.join(self._state_dir, "tables")
